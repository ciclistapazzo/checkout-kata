...
public class CheckoutServiceTest
{
    ...
    public async Task CheckoutService_ScanAsync_FirstTimeRound_GetsDiscounts()
    {
        ...
        var checkoutService = new CheckoutService(It.IsAny<IMediator>(), discountRepositoryMock.Object, productItemRepositoryMock.Object);
    ...
    public async Task CheckoutService_ScanAsync_GetsProductItemFromRepository()
    {
        ...
        var checkoutService = new CheckoutService(Mock.Of<IMediator>(), Mock.Of<IDiscountRepository>(), productItemRepositoryMock.Object);
    ...
    public async Task CheckoutService_ScanAsync_ProductNotFound_CorrectExceptionThrown()
    {
        var productItemRepositoryMock = new Mock<IProductItemRepository>();
        var checkoutService = new CheckoutService(Mock.Of<IMediator>(), Mock.Of<IDiscountRepository>(), productItemRepositoryMock.Object);
        productItemRepositoryMock.Setup(p => p.GetProductItemAsync(It.IsAny<string>())).ReturnsAsync((ProductItem?)null);
